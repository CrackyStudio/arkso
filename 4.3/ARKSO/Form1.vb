...
#Region "SettingsControls"
        ...
        With MapIs
            ...
            .Items.Add("Extinction")
            .Items.Add("Valguero_P")
        End With
        With Players
    ...
    Private Overloads Sub OnClick(sender As Object, e As EventArgs)
        ...
        ElseIf sender Is MEditButton Then
            ...
            If MEdit.Text = "Game.ini" Then
                Dim GameINI As String = pathis & "\steamapps\common\ARK Survival Evolved Dedicated Server\ShooterGame\Saved\Config\WindowsServer\Game.ini"
